...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/product-form.css')); ?>">
    ...
    <div class="input-group">
                        ...
                        <optgroup label="<?php echo e($category->name); ?>">
                            <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sub->id); ?>"
                                    <?php echo e(old('subcategory_id') == $sub->id ? 'selected' : ''); ?>>
                                    <?php echo e($sub->name); ?>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   value="<?php echo e(old('small_description')); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="description"
                      name="description"
                      placeholder="lorem ipsum"><?php echo e(old('description')); ?></textarea>
        </div>
...
<?php /**PATH D:\PROGRAMMATION WEB 4\plateforme-de-e-commerce\resources\views/product-form.blade.php ENDPATH**/ ?>