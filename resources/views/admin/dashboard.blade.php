...
<body>
  ...
  <div class="container">
    <aside>
      <ul>
        <li onclick="window.location.href='dashboard.html';" style="cursor: pointer;" class="active"><i
        ...
        <li onclick="window.location.href='profile.html';" style="cursor: pointer;"><i
           class="fa-solid fa-user"></i>Profile</li>
