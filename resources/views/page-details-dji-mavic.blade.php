...
<head>
  ...
  <title>DJI Mavic — détails produit</title>
...
<body>
  ...
  <div class="main-container">
    <div class="product-container">
      <nav class="breadcrumbs"><ul><li><a href="home.html">Accueil</a></li><li><span>&gt;</span></li><li><a href="liste-produit.html">Drones</a></li><li><span>&gt;</span></li><li class="active">DJI Mavic</li></ul></nav>

      <main class="product-main">
        <div class="product-gallery">
          <div class="main-image"><img src="assets/images/dji/thumbnail-main.webp" alt="DJI Mavic"></div>
          <div class="thumbnails"><img src="assets/images/dji/thumbnail-main.webp" class="active" alt=""><img src="assets/images/dji/thumbnail-1.webp" alt=""></div>
        </div>

        <div class="product-info">
          <div class="rating"><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><span>4.7</span></div>
          <h1>DJI Mavic — Drone 4K, stabilisation 3 axes, capteurs d’évitement</h1>
          <div class="meta-info"><div class="inner-meta-info"><span>SKU: DJIMAVIC</span><span>Marque: <b>DJI</b></span></div><div class="inner-meta-info"><span>Disponibilité: <b class="in-stock">En stock</b></span></div></div>
          <div class="price"><span class="current-price">990.000 FCFA</span></div>

          <div class="options">
            <div class="option-group"><label>Pack</label><select class="custom-select"><option>Standard</option><option>Fly More</option></select></div>
          </div>

          <div class="actions">
            <div class="quantity-selector"><button>-</button><span>01</span><button>+</button></div>
            <button class="btn-add-to-cart" onclick="saveToNavigate('DJI Mavic 4K', 990000, 1)">Ajouter au panier</button>
      ...
      <section class="product-details-tabs">
        ...
        <div class="tab-content">
          <div class="description-content active-content">
            <h3>Description</h3>
            <p>Drone compact pour photo/vidéo 4K, transmission longue portée et capteurs intelligents pour un pilotage sécurisé.</p>
            <ul><li>Garantie 1 an</li><li>Portée de vol étendue</li><li>Pack accessoires disponible</li></ul>
          </div>
        </div>
      </section>
