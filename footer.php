  ...
  <div class="container footer-top">
    <div class="fgrid">
      ...
      <nav class="fcol" aria-label="Top Category">
        ...
        <a href="<?php echo home_url('/liste-produit'); ?>">Électronique et Accessoires</a>
        <a href="<?php echo home_url('/liste-produit'); ?>">Vêtements</a>
        <a href="<?php echo home_url('/liste-produit'); ?>">Électromenager</a>
        <a href="<?php echo home_url('/liste-produit'); ?>"><em>Meubles</em></a>
        <a href="<?php echo home_url('/liste-produit'); ?>">Bijoux</a>
        <a href="<?php echo home_url('/liste-produit'); ?>">Cosmetiques</a>
        <a class="accent" href="<?php echo home_url('/liste-produit'); ?>">Consulter tous nos produits →</a>
      </nav>
      <!-- Quick Links -->
      <nav class="fcol" aria-label="Quick Links">
        <h4>LIENS RAPIDES</h4>
        <a href="<?php echo home_url('/liste-produit'); ?>">Catalogue de produit</a>
        <a href="<?php echo home_url('/panier'); ?>">Panier de course</a>
        <a href="<?php echo home_url('/page-favoris'); ?>">Liste de souhait</a>
        <a href="<?php echo home_url('/faq'); ?>">Support client</a>
        <a href="<?php echo home_url('/about-us'); ?>">A propos de nous</a>
      </nav>
      <!-- Popular Tag -->
