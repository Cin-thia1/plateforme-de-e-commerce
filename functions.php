...
function my_theme_enqueue_assets()
{
    ...
    wp_enqueue_script('theme-panier', get_template_directory_uri() . '/assets/js/panier.js', array(), null, true);
    ...
    if (is_page('home')) {
        ...
        wp_enqueue_script('home-js', get_template_directory_uri() . '/assets/js/home.js');
        ...
        wp_enqueue_script('filtre-sous-categorie-js', get_template_directory_uri() . '/assets/js/filtre-sous-categorie.js', array(), null, true);
        wp_enqueue_script('pagination-js', get_template_directory_uri() . '/assets/js/pagination.js', array(), null, true);
        ...
        wp_enqueue_script('commande-js', get_template_directory_uri() . '/assets/js/commande.js', array(), null, true);

    } elseif (is_page('dashboard')) {
        wp_enqueue_style('dashboard-css', get_template_directory_uri() . '/assets/css/dashboard.css', array());
        wp_enqueue_script('dashboard-js', get_template_directory_uri() . '/assets/js/dashboard.js', array(), null, true);
        ...
        wp_enqueue_style('login-css', get_template_directory_uri() . '/assets/css/reset-password.css', array());
        ...
        wp_enqueue_style('signup-css', get_template_directory_uri() . '/assets/css/reset-password.css', array());
